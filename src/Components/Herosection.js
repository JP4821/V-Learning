            ...
            <Carousel fade pause>
                <Carousel.Item>
                    ...
                    <Carousel.Caption className="text-start translate-middle">
                        <h5>HOW TO BECOME A</h5>
                        <h3>FULL STACK WEB DEVELOPER?</h3>
                        <p>Start your new career as a Full Stack Web Developer</p>
                        <Button variant="warning" className="px-5">Register Now</Button>
                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item>
                ...
                <Carousel.Item>
                    ...
                    <Carousel.Caption className="text-start translate-middle">
                        <h4>Become a Full Stack Developer with V Learning Program</h4>
                        <ul>
                        ...
                        <Button variant="warning" className="px-5">Register Now</Button>
                        <Button variant="info" className="px-5 ms-2">Download Syllabus</Button>
                    </Carousel.Caption>
                </Carousel.Item>
            </Carousel>
        </section>
